 ...
 *
 * Loads the TypeScript default lib files from node_modules for tests.
 * The browser worker bundles the same files as raw assets instead
 * (see the worker entry, not this module).
 */
