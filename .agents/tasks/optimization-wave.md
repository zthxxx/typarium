...
- [x] Phase 0 — ADRs 0018–0021 + factual corrections in docs/architecture + docs/engineering
- [x] Phase 1 — trivial fixes: cursor-highlight residue (cursorOffset → computed), preset chip font size
- [x] Phase 2 — safety net: FakeLanguageAdapter + adapter contract test kit + services unit tests
...
- [x] Phase 3 — contract overhaul in one pass: descriptor (specialTypeNames, snippet template),
...
- [x] Phase 4 — features: diagram-mode selector (policy moved into VisualizationStore,
...
- [x] Phase 5 — perf & progress: cold-start measurement baseline script, monaco deferral,
...
- [x] Phase 6 — monorepo: pnpm workspace, packages set-model / diagram-euler / diagram-hasse /
